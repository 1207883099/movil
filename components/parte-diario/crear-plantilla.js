            ...
            <View style={styles.select}>
                ...
                >
                    {selectSector.map((sector, index) => (
                        <Picker.Item key={index} label={sector.Nombre + ' - ' + sector.Nombre_Hacienda} value={sector.IdSector} />
                    ))}
                </Picker>
            </View>

            <Button title='Guardar plantilla' onPress={create_Template_Parte_Diario} />
        </>
    );
}
